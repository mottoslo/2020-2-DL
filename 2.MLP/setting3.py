...
W1 = tf.get_variable("W1", shape=[784, 200]) # 첫 번째 층의 weight matrix
...
W2 = tf.get_variable("W2", shape=[200, 200]) # *hint* weight initialization을 위해 "initializer" 파라미터에 특정 초기화 기법을 입력
...
# ========================================================================
timestamp = 'setting2'  # setting 바꿀때마다 바꿔주면 폴더가 생김
