...
def load_trec_data(train_file):
    ...
    for sent in train:
        if sent[0] == 'a':
            container_y.append([1, 0, 0, 0, 0, 0])
        elif sent[0] == 'd':
            container_y.append([0, 1, 0, 0, 0, 0])
        elif sent[0] == 'e':
            container_y.append([0, 0, 1, 0, 0, 0])
        elif sent[0] == 'h':
            container_y.append([0, 0, 0, 1, 0, 0])
        elif sent[0] == 'l':
            container_y.append([0, 0, 0, 0, 1, 0])
        elif sent[0] == 'n':
            container_y.append([0, 0, 0, 0, 0, 1])
        container_x.append(" ".join(sent.split()[2:]))
    return container_x, np.array(container_y)
